...
public class Nim {
	public static void main(String[] args) {
		...
		while (whichMoves > 2 || whichMoves <= 0) {
		...
		if (whichMoves == 1) {
			...
			System.out.println("Round "+ i + " " + numSticks + " sticks at start, human took " + humanMoves + " sticks, so " + (numSticks-humanMoves) + " sticks remain.");
		...
		while(numSticks > 0){
			...
			System.out.println("Round "+ i + " " + numSticks + " sticks at start, computer took " + compMoves + " sticks, so " + (numSticks-compMoves) + " sticks remain.") ;
