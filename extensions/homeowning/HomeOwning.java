...
public class HomeOwning {
	...
	public static void main(String[] args) {
		...
		int interest = ap.nextInt("How much the daily interset of a mortage, if it's $300.00, please enter 30000");
		String x = rent*12 >= (interest*365/100+interest*365%100) ? "buy" : "rent";
		String y = rent/4 >= (interest*7/100+interest*7%100) ? "buy" : "reen";
